...
if choice == "Start":
    ...
    st.subheader("Please write to: **e.grant@skimgroup.com** (Updating Miguel's code) for any questions, issues or suggestions.")
    ...
    st.subheader("Please Process the data in the excel Tool")
    st.write("Go to the folder below, download the excel tool, input the data from the previous step and run the macro to process the data.")
        ...
        if data_file2 is not None:
            ...
            for i in range(number_of_products):
                ...
                if color_settings == 'CMI':
                    series.format.line.color.rgb = RGBColor(31, 183, 143)
                else:
                ...
                if color_settings == 'CMI':
                    series.format.line.color.rgb = RGBColor(163, 155, 217)
                else:
                ...
                if color_settings == 'CMI':
                    series.marker.format.fill.fore_color.rgb = RGBColor(31, 183, 143)
                else:
                ...
                if color_settings == 'CMI':
                    data_label.font.color.rgb = RGBColor(31, 183, 143)
                else:
                ...
                if check:
                    ...
                    series = plot.series[4]
                    series.format.line.color.rgb = RGBColor(0,176,80)
                    series.marker.size = 24
                    series.marker.format.fill.background()
                    series.marker.format.line.fill.solid()
                    series.marker.format.line.fill.fore_color.rgb = RGBColor(0,176,80)
                    series.marker.format.line.width = Pt(3.5)
                    ...
                    plot = chart.plots[0]
                    series = plot.series[6]
                    series.format.line.color.rgb = RGBColor(28,109,125)
                    series.marker.size = 24
                    series.marker.format.fill.background()
                    series.marker.format.line.fill.solid()
                    series.marker.format.line.fill.fore_color.rgb = RGBColor(28,109,125)
                    series.marker.format.line.width = Pt(3.5)
                    series.marker.style = XL_MARKER_STYLE.CIRCLE

                    plot = chart.plots[0]
                    series = plot.series[7]
                    series.format.line.color.rgb = RGBColor(239,123,38)
                    series.format.line.dash_style = 4

                    plot = chart.plots[0]
                    series = plot.series[8]
                    series.format.line.color.rgb = RGBColor(239,123,38)
                    series.marker.size = 24
                    series.marker.format.fill.background()
                    series.marker.format.line.fill.solid()
                    series.marker.format.line.fill.fore_color.rgb = RGBColor(239,123,38)
                    series.marker.format.line.width = Pt(3.5)
                    series.marker.style = XL_MARKER_STYLE.CIRCLE
